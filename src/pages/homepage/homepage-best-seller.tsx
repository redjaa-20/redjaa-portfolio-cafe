    ...
    <section className="bg-custom-green-500 py-[50px] lg:py-15 text-beige-100">
      <div className="max-w-6xl px-5 md:px-5 lg:px-0 mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-6">
          <div className="flex gap-10 items-center lg:col-span-3">
            <div className="grid grid-rows-2 gap-y-3 lg:gap-y-4 order-2 lg:order-1 text-sm lg:text-base font-semibold">
              <div className="grid grid-cols-5 h-50 lg:h-70 gap-3">
                <div className="col-span-3">
                  <ScrollReveal type="slide-up" delay={0.3}>
                    <div className="relative rounded-xl lg:rounded-3xl overflow-hidden h-50 lg:h-70">
              ...
              <div className="grid grid-cols-5 gap-3">
                ...
                <div className="col-span-3">
                  <ScrollReveal type="slide-up" delay={0.6}>
                    <div className="relative rounded-xl lg:rounded-3xl overflow-hidden h-50 lg:h-70">
          ...
          <div className="lg:col-span-3 lg:pl-20 order-1 lg:order-2 flex items-center">
